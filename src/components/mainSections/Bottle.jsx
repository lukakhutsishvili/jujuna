...
function Bottle() {
  return (
    <div id="ბოთლი" className="xl:mx-20 dark:text-white">
      ...
      <div className="xl:justify-between xl:pr-[60px] xl:bg-[url('/images/Vector5.png')] xl:h-[482px] xl:bg-right bg-no-repeat bg-[url('/images/littleBlackDiv.png')] bg-customRight  xl:p-0 border-t-2 border-b-2 border-[#613994] pt-[14px] pb-[14px] pr-[20px] pl-[9px] flex gap-5">
